...
ActiveRecord::Schema.define(version: 20_191_120_145_925) do
  create_table 'budget_details', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4', force: :cascade do |t|
    ...
    t.index %w[budget_plan_id category_id], name: 'index_budget_details_on_budget_plan_id_and_category_id', unique: true
  ...
  create_table 'budget_plans', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8mb4', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[user_id plan_date], name: 'index_budget_plans_on_user_id_and_plan_date', unique: true
